...
\include{chapters/LongAbstract}

\quickwordcount{chapters/LongAbstract}
\quickcharcount{chapters/LongAbstract}
...
%Numero di caratteri: \the\numexpr\theword+\thechar\relax\ /3000 $\pm$ 300

%\include{chapters/bibliografiaprova}
